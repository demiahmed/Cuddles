...
export const getHeartIcon = (protection: ProtectionType | undefined, className: string = "w-3.5 h-3.5 text-pink-500") => {
  switch (protection) {
    case 'protected':
      return <ProtectedHeart className={className.replace('text-pink-500', 'text-gray-500')} />;
    case 'unprotected':
      return <UnprotectedHeart className={className} />;
    default:
      return <GenericHeart className={className} />;
  }
};